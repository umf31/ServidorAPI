...
//              MetasController: Creado 15-06-2022
//=======================================================================
...
namespace ServidorAPI.Controladores.Sadim
{
    ...
    [ApiController]
    [Authorize]
    public class MetasController : BaseController<Meta, MetaEditar, MetaInsertar, MetaRespuesta, MetaConsulta>
    {
        public MetasController(IMapper mapper, ILogicaMeta<Meta> logica, IPaginacion<Meta> paginacion)
            : base(mapper, logica, paginacion, Controlador.Nombre.Meta)
        { }

        [AllowAnonymous]
        [HttpGet]
        public override Task<IActionResult> ObtenerTodo(MetaConsulta consulta)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Insertar(MetaInsertar entidadInsertar, string matricula)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Editar(string matricula, int id, [FromForm] MetaEditar entidadEditar)
        {
