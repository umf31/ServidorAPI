...
//              CategoriasController: Creado 14-06-2022
//=======================================================================
...
{
    [Route(Ruta.Api.Categoria)]
    [Produces(TipoArchivo.ApplicationJson)]
    [ApiExplorerSettings(GroupName = Plataforma.Servidor)]
    [ApiController]
    [Authorize]
    public class CategoriasController : BaseController<Categoria, CategoriaEditar, CategoriaInsertar, CategoriaRespuesta, CategoriaConsulta>
    {
        public CategoriasController(IMapper mapper, ILogicaCategoria<Categoria> logica, IPaginacion<Categoria> paginacion)
            : base(mapper, logica, paginacion, Controlador.Nombre.Categoria)
        { }

        [AllowAnonymous]
        [HttpGet]
        public override Task<IActionResult> ObtenerTodo(CategoriaConsulta consulta)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Insertar(CategoriaInsertar entidadInsertar, string matricula)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Editar(string matricula, int id, [FromForm] CategoriaEditar entidadEditar)
        {
