...
//              EmpleadosController: Creado 14-06-2022
//=======================================================================
...
{
    [Route(Ruta.Api.Empleado)]
    [Produces(TipoArchivo.ApplicationJson)]
    [ApiExplorerSettings(GroupName = Plataforma.Servidor)]
    [ApiController]
    [Authorize]
    public class EmpleadosController : BaseController<Empleado, EmpleadoEditar, EmpleadoInsertar, EmpleadoRespuesta, EmpleadoConsulta>
    {
        public EmpleadosController(IMapper mapper, ILogicaEmpleado<Empleado> logica, IPaginacion<Empleado> paginacion)
            : base(mapper, logica, paginacion, Controlador.Nombre.Empleado)
        { }

        [AllowAnonymous]
        [HttpGet]
        public override Task<IActionResult> ObtenerTodo(EmpleadoConsulta consulta)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Insertar(EmpleadoInsertar entidadInsertar, string matricula)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Editar(string matricula, int id, [FromForm] EmpleadoEditar entidadEditar)
        {
