...
//              MunicipiosController: Creado 14-06-2022
//=======================================================================
...
{
    [Route(Ruta.Api.Municipio)]
    [Produces(TipoArchivo.ApplicationJson)]
    [ApiExplorerSettings(GroupName = Plataforma.Servidor)]
    [ApiController]
    [Authorize]
    public class MunicipiosController : BaseController<Municipio, MunicipioEditar, MunicipioInsertar, MunicipioRespuesta, MunicipioConsulta>
    {
        public MunicipiosController(IMapper mapper, ILogicaMunicipio<Municipio> logica, IPaginacion<Municipio> paginacion)
            : base(mapper, logica, paginacion, Controlador.Nombre.Municipio)
        { }

        [AllowAnonymous]
        [HttpGet]
        public override Task<IActionResult> ObtenerTodo(MunicipioConsulta consulta)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Insertar(MunicipioInsertar entidadInsertar, string matricula)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Editar(string matricula, int id, [FromForm] MunicipioEditar entidadEditar)
        {
