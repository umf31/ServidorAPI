...
//              StatusController: Creado 14-06-2022
//=======================================================================
...
{
    [Route(Ruta.Api.Status)]
    [Produces(TipoArchivo.ApplicationJson)]
    [ApiExplorerSettings(GroupName = Plataforma.Servidor)]
    [ApiController]
    [Authorize]
    public class StatusController : BaseController<Status, StatusEditar, StatusInsertar, StatusRespuesta, StatusConsulta>
    {
        public StatusController(IMapper mapper, ILogicaStatus<Status> logica, IPaginacion<Status> paginacion)
            : base(mapper, logica, paginacion, Controlador.Nombre.Status)
        { }

        [AllowAnonymous]
        [HttpGet]
        public override Task<IActionResult> ObtenerTodo(StatusConsulta consulta)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Insertar(StatusInsertar entidadInsertar, string matricula)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Editar(string matricula, int id, [FromForm] StatusEditar entidadEditar)
        {
