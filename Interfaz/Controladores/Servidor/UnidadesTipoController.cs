...
//              UnidadesTipoController: Creado 14-06-2022
//=======================================================================
...
{
    [Route(Ruta.Api.UnidadTipo)]
    [Produces(TipoArchivo.ApplicationJson)]
    [ApiExplorerSettings(GroupName = Plataforma.Servidor)]
    [ApiController]
    [Authorize]
    public class UnidadesTipoController : BaseController<UnidadTipo, UnidadTipoEditar, UnidadTipoInsertar, UnidadTipoRespuesta, UnidadTipoConsulta>
    {
        public UnidadesTipoController(IMapper mapper, ILogicaUnidadTipo<UnidadTipo> logica, IPaginacion<UnidadTipo> paginacion)
            : base(mapper, logica, paginacion, Controlador.Nombre.UnidadTipo)
        { }

        [AllowAnonymous]
        [HttpGet]
        public override Task<IActionResult> ObtenerTodo(UnidadTipoConsulta consulta)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Insertar(UnidadTipoInsertar entidadInsertar, string matricula)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Editar(string matricula, int id, [FromForm] UnidadTipoEditar entidadEditar)
        {
