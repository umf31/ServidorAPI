...
//              VialidadesController: Creado 14-06-2022
//=======================================================================
...
{
    [Route(Ruta.Api.Vialidad)]
    [Produces(TipoArchivo.ApplicationJson)]
    [ApiExplorerSettings(GroupName = Plataforma.Servidor)]
    [ApiController]
    [Authorize]
    public class VialidadesController : BaseController<Vialidad, VialidadEditar, VialidadInsertar, VialidadRespuesta, VialidadConsulta>
    {
        public VialidadesController(IMapper mapper, ILogicaVialidad<Vialidad> logica, IPaginacion<Vialidad> paginacion)
            : base(mapper, logica, paginacion, Controlador.Nombre.Vialidad)
        { }

        [AllowAnonymous]
        [HttpGet]
        public override Task<IActionResult> ObtenerTodo(VialidadConsulta consulta)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Insertar(VialidadInsertar entidadInsertar, string matricula)
        {
        ...
        [AllowAnonymous]
        public override Task<IActionResult> Editar(string matricula, int id, [FromForm] VialidadEditar entidadEditar)
        {
