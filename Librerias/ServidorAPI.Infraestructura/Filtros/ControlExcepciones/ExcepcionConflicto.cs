...
//                ExcepcionConflicto: Creado 13-06-2022
//=======================================================================
...
{
    public class ExcepcionConflicto : IExceptionFilter
    {
        public void OnException(ExceptionContext context)
        {
            if (context.Exception.GetType() == typeof(Conflict))
            {
                var excepcion = (Conflict)context.Exception;
                var validacion = new DetalleRespuesta
                {
                    Resultado = false,
                    Encabezado = Mensaje.Encabezado.StatusCode409,
                    Detalle = excepcion.Message,
                    StatusCode = Mensaje.Excepcion.StatusCode409,
