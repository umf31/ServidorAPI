...
//               ExcepcionErrorInterno: Creado 13-06-2022
//=======================================================================
...
{
    public class ExcepcionErrorInterno : IExceptionFilter
    {
        public void OnException(ExceptionContext context)
        {
            if (context.Exception.GetType() == typeof(InternalServerError))
            {
                var excepcion = (InternalServerError)context.Exception;
