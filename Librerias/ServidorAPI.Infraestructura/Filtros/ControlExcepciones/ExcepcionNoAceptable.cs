...
//               ExcepcionNoAceptable: Creado 13-06-2022
//=======================================================================
...
{
    public class ExcepcionNoAceptable : IExceptionFilter
    {
        public void OnException(ExceptionContext context)
        {
            if (context.Exception.GetType() == typeof(NotAcceptable))
            {
                var excepcion = (NotAcceptable)context.Exception;
                var validacion = new DetalleRespuesta
                {
                    Resultado = false,
                    Encabezado = Mensaje.Encabezado.StatusCode406,
                    Detalle = excepcion.Message,
                    StatusCode = Mensaje.Excepcion.StatusCode406,
