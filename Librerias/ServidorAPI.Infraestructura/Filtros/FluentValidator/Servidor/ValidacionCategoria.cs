...
//              ValidacionCategoria: Creado 13-06-2022
//=======================================================================
...
{
    public class ValidacionCategoriaInsertar : AbstractValidator<CategoriaInsertar>
    {
        public ValidacionCategoriaInsertar()
        {
            RuleFor(x => x.Nombre).NombreReq();
        }
    }

    public class ValidacionCategoriaEditar : AbstractValidator<CategoriaEditar>
    {
        public ValidacionCategoriaEditar()
        {
