...
//                 ValidacionVialidad: Creado 13-06-2022
//=======================================================================
...
{
    public class ValidacionVialidadInsertar : AbstractValidator<VialidadInsertar>
    {
        public ValidacionVialidadInsertar()
        {
            RuleFor(x => x.Nombre).NombreReq();
        }
    }

    public class ValidacionVialidadEditar : AbstractValidator<VialidadEditar>
    {
        public ValidacionVialidadEditar()
        {
