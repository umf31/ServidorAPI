...
//              CervicoUterinoMapper: Creado 15-06-2022
//=======================================================================
...
{
    public class CervicoUterinoMapper : Profile
    {
        public CervicoUterinoMapper()
        {
            CreateMap<CP02_IMCP_08M, CaCu01Unidad>()
                .ForMember(dest => dest.ClavePresupuestal, opt => opt.MapFrom(origen => origen.CvePresup));

            CreateMap<CaCu01Unidad, IndicadorRespuesta>()
                .ForMember(dest => dest.MesAbrev, opt => opt.MapFrom(origen => origen.Periodos.MesAbrev));

            CreateMap<Lista<CaCu01Unidad>, Metadatos>()
