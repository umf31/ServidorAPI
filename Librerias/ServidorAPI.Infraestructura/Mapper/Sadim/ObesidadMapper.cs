...
//                 ObesidadMapper: Creado 15-06-2022
//=======================================================================
...
{
    public class ObesidadMapper : Profile
    {
        public ObesidadMapper()
        {
            CreateMap<CP04_IMCP20, SOb01Unidad>()
               .ForMember(dest => dest.ClavePresupuestal, opt => opt.MapFrom(origen => origen.CvePresup));

            CreateMap<SOb01Unidad, IndicadorRespuesta>()
                .ForMember(dest => dest.MesAbrev, opt => opt.MapFrom(origen => origen.Periodos.MesAbrev));

            CreateMap<Lista<SOb01Unidad>, Metadatos>()
