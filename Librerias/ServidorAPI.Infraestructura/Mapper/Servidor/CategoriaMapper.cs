...
//             Mapeo CategoriaMapper: Creado 13-06-2022
//=======================================================================
...
namespace ServidorAPI.Infraestructura.Mapper.Servidor
{
    public class CategoriaMapper : Profile
    {
        public CategoriaMapper()
        {
            ...
            CreateMap<CategoriaEditar, Categoria>()
                .ForMember(dest => dest.Status, opt => opt.Ignore())
                .ForMember(dest => dest.CategoriaServicio, opt => opt.Ignore())
                .ForMember(dest => dest.Empleados, opt => opt.Ignore())
                .ForMember(dest => dest.Id, opt => opt.Ignore())
