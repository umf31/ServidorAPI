...
//              Mapeo UnidadTipoMapper: Creado 13-06-2022
//=======================================================================
...
{
    public class UnidadTipoMapper : Profile
    {
        public UnidadTipoMapper()
        {
            CreateMap<UnidadTipo, UnidadTipoRespuesta>();

            CreateMap<Lista<UnidadTipo>, Metadatos>()
             .ForMember(dest => dest.PaginaSiguiente, opt => opt.Ignore())
             .ForMember(dest => dest.PaginaAnterior, opt => opt.Ignore());

            CreateMap<UnidadTipoSoporte, UnidadTipo>()
