...
//            AsistenteCaMama03Unidad: Creado 15-06-2022
//=======================================================================
...
{
    public class AsistenteCaMama03Unidad : AsistenteIndicador<CaMama03Unidad>, IAsistenteCaMama03Unidad
    {
        private readonly SadimContexto dbs;
        public AsistenteCaMama03Unidad(SadimContexto _dbs, ServidorContexto db) : base(db, _dbs)
        {
            dbs = _dbs;
        }

        public async Task<IEnumerable<CaMama03Unidad>> ObtenerTodoFiltros()
        {
