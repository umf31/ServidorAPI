...
//            AsistenteCaispn09Unidad: Creado 15-06-2022
//=======================================================================
...
{
    public class AsistenteCaispn09Unidad : AsistenteIndicador<Caispn09Unidad>, IAsistenteCaispn09Unidad
    {
        private readonly SadimContexto dbs;
        public AsistenteCaispn09Unidad(SadimContexto _dbs, ServidorContexto db) : base(db, _dbs)
        {
            dbs = _dbs;
        }

        public async Task<IEnumerable<Caispn09Unidad>> ObtenerTodoFiltros()
        {
        ...
        public async Task<PU01_ParteUno> ObtenerPU01_ParteUno(string periodo)
        {
            var pu01_ParteUno = await dbs.PU01_ParteUno
                .Where(x => x.Servicio == "04" && x.Matricula == "999999999999" && x.Especial == 0 && x.Periodo == periodo).FirstOrDefaultAsync();
