...
//              AsistenteDetalle: Creado 14-06-2022
//=======================================================================
...
namespace ServidorAPI.Persistencia.Asistente.Sadim
{
    public class AsistenteDetalle : ServidorBase<Detalles>, IAsistenteDetalle
    {
        ...
        public async Task<Detalles> ObtenerPorNombre(string? nombre)
        {
            var entidad = await entidades.Where(x => x.Nombre == nombre).FirstOrDefaultAsync();
            if (entidad != null)
            {
                return entidad;
            }
