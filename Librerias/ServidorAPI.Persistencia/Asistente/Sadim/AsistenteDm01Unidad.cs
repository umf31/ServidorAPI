...
//                AsistenteDm01Unidad: Creado 15-06-2022
//=======================================================================
...
{
    public class AsistenteDm01Unidad : AsistenteIndicador<Dm01Unidad>, IAsistenteDm01Unidad
    {
        private readonly SadimContexto dbs;

        public AsistenteDm01Unidad(SadimContexto _dbs, ServidorContexto db) : base(db, _dbs)
        {
            dbs = _dbs;
        }

        public async Task<IEnumerable<Dm01Unidad>> ObtenerTodoFiltros()
        {
