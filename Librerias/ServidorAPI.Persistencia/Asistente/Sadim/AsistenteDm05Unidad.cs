...
//                AsistenteDm05Unidad: Creado 15-06-2022
//=======================================================================
...
{
    public class AsistenteDm05Unidad : AsistenteIndicador<Dm05Unidad>, IAsistenteDm05Unidad
    {
        private readonly SadimContexto dbs;

        public AsistenteDm05Unidad(SadimContexto _dbs, ServidorContexto db) : base(db, _dbs)
        {
            dbs = _dbs;
        }

        public async Task<IEnumerable<Dm05Unidad>> ObtenerTodoFiltros()
        {
