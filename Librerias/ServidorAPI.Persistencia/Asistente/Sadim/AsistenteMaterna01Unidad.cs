...
//              AsistenteMaterna01Unidad: Creado 15-06-2022
//=======================================================================
...
{
    public class AsistenteMaterna01Unidad : AsistenteIndicador<Materna01Unidad>, IAsistenteMaterna01Unidad
    {
        private readonly SadimContexto dbs;
        public AsistenteMaterna01Unidad(SadimContexto _dbs, ServidorContexto db) : base(db, _dbs)
        {
            dbs = _dbs;
        }

        public async Task<IEnumerable<Materna01Unidad>> ObtenerTodoFiltros()
        {
