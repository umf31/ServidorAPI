...
//               AsistenteSOb01Unidad: Creado 15-06-2022
//=======================================================================
...
{
    public class AsistenteSOb01Unidad : AsistenteIndicador<SOb01Unidad>, IAsistenteSOb01Unidad
    {
        private readonly SadimContexto dbs;
        public AsistenteSOb01Unidad(SadimContexto _dbs, ServidorContexto db) : base(db, _dbs)
        {
            dbs = _dbs;
        }

        public async Task<IEnumerable<SOb01Unidad>> ObtenerTodoFiltros()
        {
