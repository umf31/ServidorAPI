...
//                 AsistenteCategoria: Creado 14-06-2022
//=======================================================================
...
{
    public class AsistenteCategoria : ServidorAsistente<Categoria>, IAsistenteCategoria
    {
        public AsistenteCategoria(ServidorContexto db) : base(db)
        {
        }
    }
}