...
//                AsistenteDelegacion: Creado 14-06-2022
//=======================================================================
...
namespace ServidorAPI.Persistencia.Asistente.Servidor
{
    public class AsistenteDelegacion : ServidorAsistente<Delegacion>, IAsistenteDelegacion
    {
        ...
        public async Task<IEnumerable<Delegacion>> ObtenerTodoFiltros()
        {
            var entidad = entidades.Where(x => x.StatusId == 1).Include(x => x.Estado).AsEnumerable();
