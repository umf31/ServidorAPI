...
//              CaCu01UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class CaCu01UnidadFluentAPI : IEntityTypeConfiguration<CaCu01Unidad>
    {
        public void Configure(EntityTypeBuilder<CaCu01Unidad> builder)
        {
            builder.ToTable("CaCu01Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_CaCu01Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_CaCu01Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.CaCu01Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.CaCu01Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
            ...
            builder.Property(e => e.Poblacion).HasColumnOrder(8).HasColumnType("decimal(12, 0)");
            builder.Property(e => e.Prevalencia).HasColumnOrder(9).HasColumnType("decimal(12, 2)");
