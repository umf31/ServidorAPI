...
//              CaMama01UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class CaMama01UnidadFluentAPI : IEntityTypeConfiguration<CaMama01Unidad>
    {
        public void Configure(EntityTypeBuilder<CaMama01Unidad> builder)
        {
            builder.ToTable("CaMama01Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_CaMama01Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_CaMama01Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.CaMama01Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.CaMama01Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
