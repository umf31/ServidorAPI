...
//              CaMama02UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class CaMama02UnidadFluentAPI : IEntityTypeConfiguration<CaMama02Unidad>
    {
        public void Configure(EntityTypeBuilder<CaMama02Unidad> builder)
        {
            builder.ToTable("CaMama02Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_CaMama02Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_CaMama02Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.CaMama02Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.CaMama02Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
