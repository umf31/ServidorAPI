...
//              CaMama03UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class CaMama03UnidadFluentAPI : IEntityTypeConfiguration<CaMama03Unidad>
    {
        public void Configure(EntityTypeBuilder<CaMama03Unidad> builder)
        {
            builder.ToTable("CaMama03Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_CaMama03Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_CaMama03Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.CaMama03Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.CaMama03Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
