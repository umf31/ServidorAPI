...
//              Caispn02UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Caispn02UnidadFluentAPI : IEntityTypeConfiguration<Caispn02Unidad>
    {
        public void Configure(EntityTypeBuilder<Caispn02Unidad> builder)
        {
            builder.ToTable("Caispn02Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Caispn02Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Caispn02Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Caispn02Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Caispn02Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
