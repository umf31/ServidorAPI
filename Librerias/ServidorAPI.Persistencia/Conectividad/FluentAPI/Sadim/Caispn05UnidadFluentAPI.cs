...
//              Caispn05UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Caispn05UnidadFluentAPI : IEntityTypeConfiguration<Caispn05Unidad>
    {
        public void Configure(EntityTypeBuilder<Caispn05Unidad> builder)
        {
            builder.ToTable("Caispn05Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Caispn05Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Caispn05Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Caispn05Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Caispn05Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
