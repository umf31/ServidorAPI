...
//              Caispn08UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Caispn08UnidadFluentAPI : IEntityTypeConfiguration<Caispn08Unidad>
    {
        public void Configure(EntityTypeBuilder<Caispn08Unidad> builder)
        {
            builder.ToTable("Caispn08Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Caispn08Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Caispn08Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Caispn08Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Caispn08Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
