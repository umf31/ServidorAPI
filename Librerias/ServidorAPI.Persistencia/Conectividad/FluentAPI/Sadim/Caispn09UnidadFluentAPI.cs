...
//              Caispn09UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Caispn09UnidadFluentAPI : IEntityTypeConfiguration<Caispn09Unidad>
    {
        public void Configure(EntityTypeBuilder<Caispn09Unidad> builder)
        {
            builder.ToTable("Caispn09Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Caispn09Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Caispn09Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Caispn09Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Caispn09Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
