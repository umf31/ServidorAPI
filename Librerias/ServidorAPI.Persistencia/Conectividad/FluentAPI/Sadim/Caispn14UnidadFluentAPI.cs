...
//              Caispn14UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Caispn14UnidadFluentAPI : IEntityTypeConfiguration<Caispn14Unidad>
    {
        public void Configure(EntityTypeBuilder<Caispn14Unidad> builder)
        {
            builder.ToTable("Caispn14Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Caispn14Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Caispn14Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Caispn14Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Caispn14Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
