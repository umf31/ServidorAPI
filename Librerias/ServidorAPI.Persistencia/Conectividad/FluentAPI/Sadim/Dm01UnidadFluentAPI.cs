...
//              Dm01UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Dm01UnidadFluentAPI : IEntityTypeConfiguration<Dm01Unidad>
    {
        public void Configure(EntityTypeBuilder<Dm01Unidad> builder)
        {
            builder.ToTable("Dm01Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Dm01Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Dm01Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Dm01Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Dm01Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
