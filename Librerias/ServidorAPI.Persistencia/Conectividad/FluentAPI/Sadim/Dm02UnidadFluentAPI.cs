...
//              Dm02UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Dm02UnidadFluentAPI : IEntityTypeConfiguration<Dm02Unidad>
    {
        public void Configure(EntityTypeBuilder<Dm02Unidad> builder)
        {
            builder.ToTable("Dm02Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Dm02Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Dm02Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Dm02Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Dm02Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
