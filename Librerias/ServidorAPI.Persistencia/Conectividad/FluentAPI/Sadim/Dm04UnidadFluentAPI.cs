...
//               Dm04UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Dm04UnidadFluentAPI : IEntityTypeConfiguration<Dm04Unidad>
    {
        public void Configure(EntityTypeBuilder<Dm04Unidad> builder)
        {
            builder.ToTable("Dm04Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Dm04Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Dm04Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Dm04Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Dm04Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
