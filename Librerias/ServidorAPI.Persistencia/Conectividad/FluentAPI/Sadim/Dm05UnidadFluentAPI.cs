...
//              Dm05UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Dm05UnidadFluentAPI : IEntityTypeConfiguration<Dm05Unidad>
    {
        public void Configure(EntityTypeBuilder<Dm05Unidad> builder)
        {
            builder.ToTable("Dm05Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Dm05Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Dm05Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Dm05Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Dm05Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
