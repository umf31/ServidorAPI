...
//              Eh01UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Eh01UnidadFluentAPI : IEntityTypeConfiguration<Eh01Unidad>
    {
        public void Configure(EntityTypeBuilder<Eh01Unidad> builder)
        {
            builder.ToTable("Eh01Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Eh01Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Eh01Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Eh01Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Eh01Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
