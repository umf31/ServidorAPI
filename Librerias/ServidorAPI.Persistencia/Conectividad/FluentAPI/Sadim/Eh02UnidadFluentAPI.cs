...
//              Eh02UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Eh02UnidadFluentAPI : IEntityTypeConfiguration<Eh02Unidad>
    {
        public void Configure(EntityTypeBuilder<Eh02Unidad> builder)
        {
            builder.ToTable("Eh02Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Eh02Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Eh02Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Eh02Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Eh02Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
