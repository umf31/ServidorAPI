...
//            Materna01UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Materna01UnidadFluentAPI : IEntityTypeConfiguration<Materna01Unidad>
    {
        public void Configure(EntityTypeBuilder<Materna01Unidad> builder)
        {
            builder.ToTable("Materna01Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Materna01Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Materna01Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Materna01Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Materna01Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
