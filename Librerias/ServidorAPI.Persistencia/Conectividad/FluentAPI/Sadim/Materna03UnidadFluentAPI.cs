...
//            Materna03UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Materna03UnidadFluentAPI : IEntityTypeConfiguration<Materna03Unidad>
    {
        public void Configure(EntityTypeBuilder<Materna03Unidad> builder)
        {
            builder.ToTable("Materna03Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Materna03Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Materna03Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Materna03Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Materna03Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
