...
//            Materna04UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class Materna04UnidadFluentAPI : IEntityTypeConfiguration<Materna04Unidad>
    {
        public void Configure(EntityTypeBuilder<Materna04Unidad> builder)
        {
            builder.ToTable("Materna04Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_Materna04Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_Materna04Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.Materna04Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.Materna04Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
