...
//              SOb01UnidadFluentAPI: Creado 15-06-2022
//=======================================================================
...
{
    public class SOb01UnidadFluentAPI : IEntityTypeConfiguration<SOb01Unidad>
    {
        public void Configure(EntityTypeBuilder<SOb01Unidad> builder)
        {
            builder.ToTable("SOb01Unidad", "sadim");
            builder.HasIndex(e => e.StatusId, "IX_SOb01Unidad_StatusId");
            builder.HasIndex(e => e.PeriodoId, "IX_SOb01Unidad_PeriodoId");
            builder.HasOne(d => d.Periodos).WithMany(p => p.SOb01Unidad).HasForeignKey(d => d.PeriodoId);
            builder.HasOne(d => d.Status).WithMany(p => p.SOb01Unidad).OnDelete(DeleteBehavior.ClientSetNull).HasForeignKey(d => d.StatusId);
