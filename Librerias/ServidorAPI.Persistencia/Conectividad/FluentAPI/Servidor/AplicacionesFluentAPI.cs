...
{
    public class AplicacionesFluentAPI : IEntityTypeConfiguration<Aplicaciones>
    {
        public void Configure(EntityTypeBuilder<Aplicaciones> builder)
        {
            builder.ToTable("Aplicaciones", "catalogo");
