...
//              ServicioSoporteFluentAPI: Creado 13-06-2022
//=======================================================================
...
{
    public class ServicioFluentAPI : IEntityTypeConfiguration<ServicioSoporte>
    {
        public void Configure(EntityTypeBuilder<ServicioSoporte> builder)
        {
            builder.ToTable("Servicios");
            builder.HasKey(e => e.IdServicio);

            builder.Property(e => e.IdServicio).HasColumnOrder(0).ValueGeneratedNever();
            builder.Property(e => e.ClaveServicio).HasColumnOrder(1).IsRequired().IsUnicode(false);
            ...
            builder.Property(e => e.StatusId).HasColumnOrder(6).IsRequired();
        }
    }
}