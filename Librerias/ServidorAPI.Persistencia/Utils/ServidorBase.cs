...
//                  ServidorBase: Creado 14-06-2022
//=======================================================================
...
{
    public class ServidorBase<Entidad> : IServidorBase<Entidad> where Entidad : EntidadBase
    {
        private readonly ServidorContexto db;
        protected readonly DbSet<Entidad> entidades;

        public ServidorBase(ServidorContexto _db)
        {
            db = _db;
