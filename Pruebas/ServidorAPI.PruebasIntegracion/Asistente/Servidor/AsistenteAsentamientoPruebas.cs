...
//            AsistenteAsentamientoPruebas: Creado 14-06-2022
//=======================================================================
...
{
    public class AsistenteAsentamientoPruebas : IClassFixture<SimuladorBaseDatos>
    {
        private SimuladorBaseDatos Simulador { get; }

        public AsistenteAsentamientoPruebas(SimuladorBaseDatos simulador)
        {
            Simulador = simulador;
        }

        #region => Pruebas de Integración Asentamiento AsistenteBase

        [Fact]
        public async Task ObtenerTodo_AsentamientoBase_SuperaPrueba_SiRetornaTodosLosDatos()
        {
            using var db = Simulador.CrearContexto();
            var asistente = new AsistenteAsentamiento(db);
        ...
        [Fact]
        public async Task ObtenerPorId_AsentamientoBase_SuperaPrueba_SiRetornaElementoSeleccionado()
        {
            using var db = Simulador.CrearContexto();
            var id = 1;
            var asistente = new AsistenteAsentamiento(db);
        ...
        [Fact]
        public async Task ObtenerPorId_AsentamientoBase_SuperaPrueba_LanzaExcepcionNotFound()
        {
            using var db = Simulador.CrearContexto();
            var id = 52;
            var asistente = new AsistenteAsentamiento(db);
        ...
        [Fact]
        public async Task Insertar_AsentamientoBase_SuperaPrueba_InsertaEntidad()
        {
            using (var transaction = Simulador.Conexion.BeginTransaction())
            {
                var entidadId = 0;
                var entidadInsertar = new Asentamiento
                {
                    Nombre = "Asentamiento 101",
        ...
        [Fact]
        public async Task Actualizar_AsentamientoBase_SuperaPrueba_ActualizaEstado()
        {
            using var transaction = Simulador.Conexion.BeginTransaction();
            var entidadId = 1;
        ...
        [Fact]
        public async Task Editar_AsentamientoBase_SuperaPrueba_EditaEntidad()
        {
            using var transaction = Simulador.Conexion.BeginTransaction();
            var entidadId = 1;
            var entidadEditar = new Asentamiento
            {
                Nombre = "Editar 1",
                FechaCreacion = DateTime.Now,
                FechaModificacion = DateTime.Now,
        ...
        [Fact]
        public async Task Eliminar_AsentamientoBase_SuperaPrueba_EliminaCuentaMaestra()
        {
            using var transaction = Simulador.Conexion.BeginTransaction();
            var entidadId = 51;
        ...
        [Fact]
        public async Task Eliminar_AsentamientoBase_SuperaPrueba_ActualizaEntidad()
        {
            using var transaction = Simulador.Conexion.BeginTransaction();
            var entidadId = 51;
            var matricula = "10716076";
        ...
        [Fact]
        public async Task Eliminar_AsentamientoBase_SuperaPrueba_LanzaExcepcionNotFound()
        {
            using var db = Simulador.CrearContexto();
            var id = 52;
            var asistente = new AsistenteAsentamiento(db);
        ...
        [Fact]
        public async Task ExisteEntidadPorId_AsentamientoBase_SuperaPrueba_SiExisteEntidad()
        {
            var entidadId = 1;
            using var db = Simulador.CrearContexto();
            var asistente = new AsistenteAsentamiento(db);
        ...
        [Fact]
        public async Task ExisteEntidadPorNombre_AsentamientoBase_SuperaPrueba_SiExisteEntidad()
        {
            var nombre = "Asentamiento 1";
            using var db = Simulador.CrearContexto();
            var asistente = new AsistenteAsentamiento(db);
