...
//            AsistenteCategoriaPruebas: Creado 14-06-2022
//=======================================================================
...
{
    public class AsistenteCategoriaPruebas : IClassFixture<SimuladorBaseDatos>
    {
        private SimuladorBaseDatos Simulador { get; }

        public AsistenteCategoriaPruebas(SimuladorBaseDatos simulador)
        {
            Simulador = simulador;
        }

        #region => Pruebas de Integración Categoria AsistenteBase

        [Fact]
        public async Task ObtenerTodo_CategoriaBase_SuperaPrueba_SiRetornaTodosLosDatos()
        {
            using var db = Simulador.CrearContexto();
            var asistente = new AsistenteCategoria(db);
        ...
        [Fact]
        public async Task ObtenerPorId_CategoriaBase_SuperaPrueba_SiRetornaElementoSeleccionado()
        {
            using var db = Simulador.CrearContexto();
            var id = 1;
            var asistente = new AsistenteCategoria(db);
        ...
        [Fact]
        public async Task ObtenerPorId_CategoriaBase_SuperaPrueba_LanzaExcepcionNotFound()
        {
            using var db = Simulador.CrearContexto();
            var id = 52;
            var asistente = new AsistenteCategoria(db);
        ...
        [Fact]
        public async Task Insertar_CategoriaBase_SuperaPrueba_InsertaEntidad()
        {
            using (var transaction = Simulador.Conexion.BeginTransaction())
            {
                var entidadId = 0;
                var entidadInsertar = new Categoria
                {
                    Nombre = "Categoria 101",
        ...
        [Fact]
        public async Task Actualizar_CategoriaBase_SuperaPrueba_ActualizaEstado()
        {
            using var transaction = Simulador.Conexion.BeginTransaction();
            var entidadId = 1;
        ...
        [Fact]
        public async Task Editar_CategoriaBase_SuperaPrueba_EditaEntidad()
        {
            using var transaction = Simulador.Conexion.BeginTransaction();
            var entidadId = 1;
            var entidadEditar = new Categoria
            {
                Nombre = "Editar 1",
                FechaCreacion = DateTime.Now,
                FechaModificacion = DateTime.Now,
        ...
        [Fact]
        public async Task Eliminar_CategoriaBase_SuperaPrueba_EliminaCuentaMaestra()
        {
            using var transaction = Simulador.Conexion.BeginTransaction();
            var entidadId = 51;
            var matricula = "10716076";
        ...
        [Fact]
        public async Task Eliminar_CategoriaBase_SuperaPrueba_ActualizaEntidad()
        {
            using var transaction = Simulador.Conexion.BeginTransaction();
            var entidadId = 51;
            var matricula = "10716076";
        ...
        [Fact]
        public async Task Eliminar_CategoriaBase_SuperaPrueba_LanzaExcepcionNotFound()
        {
            using var db = Simulador.CrearContexto();
            var id = 52;
            var asistente = new AsistenteCategoria(db);
        ...
        [Fact]
        public async Task ExisteEntidadPorId_CategoriaBase_SuperaPrueba_SiExisteEntidad()
        {
            var entidadId = 1;
            using var db = Simulador.CrearContexto();
            var asistente = new AsistenteCategoria(db);
        ...
        [Fact]
        public async Task ExisteEntidadPorNombre_CategoriaBase_SuperaPrueba_SiExisteEntidad()
        {
