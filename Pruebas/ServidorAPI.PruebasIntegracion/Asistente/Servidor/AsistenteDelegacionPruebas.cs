...
//             AsistenteDelegacionPruebas: Creado 14-06-2022
//=======================================================================
#endregion
...
{
    public class AsistenteDelegacionPruebas : IClassFixture<SimuladorBaseDatos>
    {
        private SimuladorBaseDatos Simulador { get; }

        public AsistenteDelegacionPruebas(SimuladorBaseDatos simulador)
        {
            Simulador = simulador;
        }

        #region => Pruebas de Integración Delegacion AsistenteBase

        [Fact]
        public async Task ObtenerTodo_DelegacionBase_SuperaPrueba_SiRetornaTodosLosDatos()
        {
            using var db = Simulador.CrearContexto();
            var asistente = new AsistenteDelegacion(db);
        ...
        [Fact]
        public async Task ObtenerPorId_DelegacionBase_SuperaPrueba_SiRetornaElementoSeleccionado()
        {
            using var db = Simulador.CrearContexto();
            var id = 1;
            var asistente = new AsistenteDelegacion(db);
        ...
        [Fact]
        public async Task ObtenerPorId_DelegacionBase_SuperaPrueba_LanzaExcepcionNotFound()
        {
            using var db = Simulador.CrearContexto();
            var id = 52;
            var asistente = new AsistenteDelegacion(db);
        ...
        [Fact]
        public async Task Insertar_DelegacionBase_SuperaPrueba_InsertaEntidad()
        {
            using (var transaction = Simulador.Conexion.BeginTransaction())
            {
                var entidadId = 0;
                var entidadInsertar = new Delegacion
                {
                    Nombre = "Delegacion 101",
                    EstadoId = 1,
                    Latitud = 23.986525M,
        ...
        [Fact]
        public async Task Actualizar_DelegacionBase_SuperaPrueba_ActualizaEstado()
        {
            using var transaction = Simulador.Conexion.BeginTransaction();
            var entidadId = 1;
        ...
        [Fact]
        public async Task Editar_DelegacionBase_SuperaPrueba_EditaEntidad()
        {
            using var transaction = Simulador.Conexion.BeginTransaction();
            var entidadId = 1;
            var entidadEditar = new Delegacion
            {
                Nombre = "Delegacion 101",
                EstadoId = 1,
                Latitud = 23.986525M,
        ...
        [Fact]
        public async Task Eliminar_DelegacionBase_SuperaPrueba_EliminaCuentaMaestra()
        {
            using var transaction = Simulador.Conexion.BeginTransaction();
            var entidadId = 51;
            var matricula = "10716076";
        ...
        [Fact]
        public async Task Eliminar_DelegacionBase_SuperaPrueba_ActualizaEntidad()
        {
            using var transaction = Simulador.Conexion.BeginTransaction();
            var entidadId = 51;
            var matricula = "10716076";
        ...
        [Fact]
        public async Task Eliminar_DelegacionBase_SuperaPrueba_LanzaExcepcionNotFound()
        {
            using var db = Simulador.CrearContexto();
            var id = 52;
            var asistente = new AsistenteDelegacion(db);
        ...
        [Fact]
        public async Task ExisteEntidadPorId_DelegacionBase_SuperaPrueba_SiExisteEntidad()
        {
            var entidadId = 1;
            using var db = Simulador.CrearContexto();
            var asistente = new AsistenteDelegacion(db);
        ...
        [Fact]
        public async Task ExisteEntidadPorNombre_DelegacionBase_SuperaPrueba_SiExisteEntidad()
        {
            var nombre = "Delegacion 1";
            using var db = Simulador.CrearContexto();
            var asistente = new AsistenteDelegacion(db);
        ...
        #region=> Pruebas de Integración AsistenteDelegacion

        [Fact]
        public async Task ObtenerTodoFiltros_AsistenteDelegacion_SuperaPrueba_SiRetornaDatosFiltrados()
        {
            using var db = Simulador.CrearContexto();
            var asistente = new AsistenteDelegacion(db);
